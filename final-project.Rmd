...
Our log model appears to be a modertly good predictor of if the article is fake news or not, suggested by the Kappa score of 0.4295. Hopefully the following models below will produce results as good or better than the log regression.

Note we did not create a linear regression due to our dependent varibles being binomial. 
